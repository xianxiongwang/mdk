---
title: Enable the operator agent
...
<!-- mdk-monorepo: duplicate of guides/agent/gateway-deployment.md, which is canonical (docs@tether_slug quashed here; content kept for engineering reference). -->
